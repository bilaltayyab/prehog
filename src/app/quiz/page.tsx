...
import { questions, personalities, personalityIds, type QuizQuestion, type Personality, type PersonalityId, type AnswerOption } from '@/lib/quiz-data';
...
export default function QuizPage() {
  ...
  const handleRestartQuiz = () => {
    ...
    setTimeout(() => {
      ...
      setResult(null);
      router.push('/quiz'); // Navigate to ensure fresh state if any query params were used
      setIsTransitioning(false);
    }, 500);
  };
