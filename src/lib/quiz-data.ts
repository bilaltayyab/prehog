...
export const questions: QuizQuestion[] = [
  {
    ...
    answers: [
        { text: "Dive into the raw data, logs, or user feedback myself.", scores: { dataGremlin: 1 } },
  ...
  },
  {
    ...
    answers: [
        ...
        { text: "Is the rollback plan/feature toggle ready, just in case things go sideways?", scores: { featureFlagFairy: 1 } }
    ]
  },
  {
    id: 'q4',
    ...
    answers: [
        ...
        { text: "Crafting perfectly worded announcement copy or update notes.", scores: { productPirate: 1 } },
  ...
  },
  {
    ...
    answers: [
        ...
        { text: "Challenge accepted. Time to iterate and win them over!", scores: { productPirate: 1 } }
    ]
  },
  {
    id: 'q6',
    ...
    answers: [
        ...
        { text: "“Clarity, consistency, and good documentation save lives (and time).”", scores: { openSourceOverlord: 1 } },
